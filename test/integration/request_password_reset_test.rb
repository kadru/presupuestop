  ...
  describe "login" do
    ...
    context "when captcha validation pass" do
      it "it redirects to the login page with a success message" do
        ...
        assert_equal translate!("rodauth.reset_password_email_sent_notice_flash"), flash[:notice]
        assert_redirected_to "/login"
      end
    end

    context "when captcha validation fails" do
      it "redirect to the reset password request page with a failure message" do
